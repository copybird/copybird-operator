	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Copybird is the Schema for the copybirds API",
...
func schema_pkg_apis_app_v1alpha1_CopybirdSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CopybirdSpec defines the desired state of Copybird",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
...
func schema_pkg_apis_app_v1alpha1_CopybirdStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CopybirdStatus defines the observed state of Copybird",
				Properties:  map[string]spec.Schema{},
			},
		},
		Dependencies: []string{},
